...
export async function POST(req: NextRequest) {
  try {
    ...
    const {
      numeroCotizacion, fechaEmision, fechaValidez,
      cliente, items, subtotal, total
    } = body
        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#f9f9f9;padding:20px">
          ...
          <div style="background:white;padding:24px;border-radius:0 0 8px 8px;border:1px solid #e5e7eb">
            ...
            <table style="width:100%;font-size:13px;color:#374151">
              ...
              <tr><td style="padding:3px 0;color:#9ca3af">Telefono:</td><td><a href="https://wa.me/593${cliente.telefono.replace(/^0/, '')}" style="color:#25D366;text-decoration:none">📱 ${cliente.telefono}</a></td></tr>
            ...
            <table style="width:100%;border-collapse:collapse;font-size:13px">
              <thead>
                <tr style="background:#f3f4f6">
                  ...
                  <th style="padding:8px 10px;text-align:right;color:#6b7280;font-weight:600">Subtotal</th>
                </tr>
              </thead>
            ...
            <div style="margin-top:16px;text-align:right">
              <p style="font-size:18px;font-weight:bold;color:#C5A059;margin:0">Total: $${total.toFixed(2)}</p>
            </div>

            <hr style="border:none;border-top:1px solid #e5e7eb;margin:16px 0">

            <a href="https://wa.me/593${cliente.telefono.replace(/^0/, '')}?text=${encodeURIComponent(`Hola ${cliente.nombres}, soy D'kore. Te contactamos por tu cotizacion ${numeroCotizacion}.`)}"
              style="display:inline-block;background:#25D366;color:white;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:bold;font-size:13px">
